class RomTimeStepper:
    ...
    E.g. both projection-based ROMs and OpInf require a numerical time integrator, discrete Koopman and
    ANN time steppers require a recurrent time stepper, and continuous Koopman requires continuous time advancing
    """
